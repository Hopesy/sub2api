...
### Publish Your Own Image (Fork Maintainers)

If you maintain a fork and want ClawCloud or other platforms to pull **your own image** instead of the upstream image, this repository includes `.github/workflows/publish-image.yml`.

Current behavior:

- Push a tag matching `v*` to build and publish a GHCR image
- Or trigger **Publish Image** manually from GitHub Actions
- The image is published to `ghcr.io/<your-github-owner>/<your-repo>`
...
After the workflow succeeds, deploy using your own image, for example:

```text
ghcr.io/<your-github-owner>/<your-repo>:v0.1.0
```

For production deployments, prefer a version tag (or a SHA tag generated by the workflow) instead of `latest`.
